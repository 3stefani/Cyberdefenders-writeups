...
|----------|------------|----------|---------|---------|---------|
| **[Oski](./oski-lab/)** | ![Easy](https://img.shields.io/badge/Easy-green) | Malware Analysis | Hash Analysis, Sandbox, MITRE ATT&CK | ✅ Complete | [📖 View]([./oski-lab/README.md](https://github.com/3stefani/Cyberdefenders-writeups/tree/main/CiberDefenders/Oski)) |
