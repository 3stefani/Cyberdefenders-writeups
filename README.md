...
|----------|------------|----------|---------|---------|---------|
| **[Oski](https://cyberdefenders.org/blueteam-ctf-challenges/oski/)** | ![Easy](https://img.shields.io/badge/Easy-green) | Malware Analysis | Hash Analysis, Sandbox, MITRE ATT&CK | ✅ Complete | [📖 View](./Oski
/Readme.md]) |
